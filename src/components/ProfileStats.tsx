...
export default function ProfileStats({
  ...
  return (
    <div className="flex w-full max-w-md justify-between items-center rounded-2xl bg-white/50 dark:bg-black/30 backdrop-blur-md p-4 mt-6 border border-neutral-200 dark:border-white/10 shadow-sm">
