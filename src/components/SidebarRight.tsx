...
export default function SidebarRight() {
  return (
    <aside className="hidden lg:flex flex-col w-72 xl:w-80 shrink-0 gap-8">
      {/* Starting from scratch - Clean slate sidebar */}
      <div className="p-5 md:p-6 bg-white dark:bg-slate-900/50 rounded-2xl border border-dashed border-slate-200 dark:border-slate-800 flex flex-col items-center justify-center text-center opacity-50">
