...
import { ModelReference, MessageData, CandidateData, GenerateRequest, ModelAction } from 'genkit/model';
 ...
 */
declare function defineGeminiModel(ai: Genkit, name: string, vertexClientFactory: (request: GenerateRequest<typeof GeminiConfigSchema>) => VertexAI, options: PluginOptions): ModelAction;

export { GeminiConfigSchema, SUPPORTED_GEMINI_MODELS, SUPPORTED_V15_MODELS, SUPPORTED_V1_MODELS, cleanSchema, defineGeminiModel, fromGeminiCandidate, gemini10Pro, gemini15Flash, gemini15Pro, gemini20FlashExp, toGeminiMessage, toGeminiSystemInstruction };
