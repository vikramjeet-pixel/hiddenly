...
exports.listAgentEngineSessionEventsRequestParametersToVertex = exports.listAgentEngineSessionEventsConfigToVertex = exports.appendAgentEngineSessionEventRequestParametersToVertex = exports.appendAgentEngineSessionEventConfigToVertex = void 0;
const common = require("@google/genai/vertex_internal");
function appendAgentEngineSessionEventConfigToVertex(fromObject, parentObject) {
    const toObject = {};
...
exports.appendAgentEngineSessionEventConfigToVertex = appendAgentEngineSessionEventConfigToVertex;
function appendAgentEngineSessionEventRequestParametersToVertex(fromObject) {
    const toObject = {};
...
exports.appendAgentEngineSessionEventRequestParametersToVertex = appendAgentEngineSessionEventRequestParametersToVertex;
function listAgentEngineSessionEventsConfigToVertex(fromObject, parentObject) {
    const toObject = {};
...
exports.listAgentEngineSessionEventsConfigToVertex = listAgentEngineSessionEventsConfigToVertex;
function listAgentEngineSessionEventsRequestParametersToVertex(fromObject) {
    const toObject = {};
    const fromName = common.getValueByPath(fromObject, ['name']);
    if (fromName != null) {
        common.setValueByPath(toObject, ['_url', 'name'], fromName);
...
exports.listAgentEngineSessionEventsRequestParametersToVertex = listAgentEngineSessionEventsRequestParametersToVertex;
//# sourceMappingURL=_sessionevents_converters.js.map